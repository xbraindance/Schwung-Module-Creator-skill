...
4. **Capture the display:** Claude uses the zoom tool to capture only the grey OLED display box in the center of the webpage (128×64 pixel area)
5. **Screenshot shows only the device display** - clean, focused, easy to analyze
